        ...
        {loading && (
          <div className="flex-1 w-full">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
              {/* Cold start warning */}
              <div className="mb-8 bg-blue-500/10 border border-blue-400/30 rounded-2xl p-4 backdrop-blur-sm">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="text-white font-semibold mb-1">Loading menu data...</h3>
                    <p className="text-sm text-gray-400">
                      First request may take 50-60 seconds as the server wakes up (free hosting limitation). 
